...
#save training data
np.save("training-0.5-data.npy", training_data_array)
np.save("training-0.5-labels.npy", training_label_array)
...
#save testing data
np.save("testing-0.5-data.npy", testing_data_array)
np.save("testing-0.5-labels.npy", testing_label_array)
