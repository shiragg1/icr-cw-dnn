...
def generate_true_data():
    ...
    #add gausian noise
    data_noisy = data + np.random.normal(0, 2, data.shape)
    return data_noisy
...
#save training data
np.save("training-2-data.npy", training_data_array)
np.save("training-2-labels.npy", training_label_array)
...
#save testing data
np.save("testing-2-data.npy", testing_data_array)
np.save("testing-2-labels.npy", testing_label_array)
